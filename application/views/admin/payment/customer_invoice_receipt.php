        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
              ...
              <td>
                ...
                <?php if($company->curr_locate == 0){echo $company->currency_symbol;} ?><?php echo number_format($service->price, $company->num_format) ?> <?php if($company->curr_locate == 1){echo $company->currency_symbol;} ?>
                    
              </td>

              <td class="text-right"><?php if($company->curr_locate == 0){echo $company->currency_symbol;} ?><?php echo number_format($price, $company->num_format) ?> <?php if($company->curr_locate == 1){echo $company->currency_symbol;} ?></td>
            </tr>
            ...
            <tr class="item">
                ...
                <td class="text-right"><span><?php if($company->curr_locate == 0){echo $company->currency_symbol;} ?><?php echo number_format($discount_amount, $company->num_format) ?> <?php if($company->curr_locate == 1){echo $company->currency_symbol;} ?></span></td>
            </tr>
            <?php endif ?>
            ...
            <tr class="item">
                ...
                <td class="text-right"><span><?php if($company->curr_locate == 0){echo $company->currency_symbol;} ?><?php echo number_format($tax_amount, $company->num_format) ?> <?php if($company->curr_locate == 1){echo $company->currency_symbol;} ?></span></td>
            </tr>
            <?php endif ?>
            ...
            <tr class="item">
                ...
                <td class="text-right"><span><strong><?php if($company->curr_locate == 0){echo $company->currency_symbol;} ?><?php echo html_escape(number_format($amount,$company->num_format)) ?> <?php if($company->curr_locate == 1){echo $company->currency_symbol;} ?></strong></span></td>
            </tr>
