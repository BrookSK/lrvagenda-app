          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="custom-control custom-switch prefrence-item pt-10 ml-0 pl-3">
                      <div class="custom-control custom-switch pt-10">
                        <input type="checkbox" value="1" name="enable_whatsapp_msg" class="custom-control-input" id="switch-1" <?php if ($this->business->enable_whatsapp_msg == 1) {
                                                                                                                                  echo 'checked';
                                                                                                                                } ?>>
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group">
                        <p><a class="text-<?php if ($this->business->whatsapp_type == 'ultramsg') {
                                            echo "primary";
                                          } else {
                                            echo "dark";
                                          } ?> fs-18 font-weight-bold" target="_blank" href="https://ultramsg.com"><?php echo trans('ultramsg') ?> <i class="lni lni-arrow-right"></i></a></p>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      <div class="form-group">
                        <p><a class="text-<?php if ($this->business->whatsapp_type == 'wazfy') {
                                            echo "primary";
                                          } else {
                                            echo "dark";
                                          } ?> fs-18 font-weight-bold" target="_blank" href="https://wazfy.com"><?php echo trans('wazfy') ?> <i class="lni lni-arrow-right"></i></a></p>
                      </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Configurações do Webhook</h4>
              </div>
              <div class="card-body">
                <form method="post" action="<?= base_url('admin/settings/update_webhook_url'); ?>">
                  <div class="form-group">
                    <label for="webhook_url">URL do Webhook</label>
                    <input type="text" class="form-control" name="webhook_url" value="<?= isset(user()->webhook_url) ? user()->webhook_url : ''; ?>" required>
                  </div>
