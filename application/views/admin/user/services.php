                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                          ...
                          <?php if($this->business->tax_type == 2): ?>
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="tax" value="<?php if(isset($service[0]['tax'])){echo html_escape($service[0]['tax']);} ?>">
                                  <div class="input-group-append">
                        ...
                        <select class="form-control is_reccuring" name="service_type" required>
                          <option value=""><?php echo trans('select') ?></option>
                          <option value="1" <?php if(isset($service[0]['service_type']) && $service[0]['service_type'] == 1) {echo 'selected';} ?>><?php echo trans('one-of-service') ?></option>
