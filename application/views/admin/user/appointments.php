                                    ...
                                    <td>
                                        ...
                                        <p class="mb-0 mt-0">
                                          ...
                                          <?php if (!empty($appointment->service_extra)): ?>
                                            <span><a data-toggle="modal" href="#extraServiceModal_<?php echo $a ?>" class="badge badge-secondary"><i class="bi bi-hdd-stack"></i> <?php echo trans('booked-service-extra') ?></a></span>
                                          <?php endif; ?>
                                        </p>
                                    </td>
              ...
              <div class="modal-body mb-4">
                ...
                <?php foreach ($service_extras as $value): ?>
                  ...
                  <div class="row px-4 py-3 bg-light mx-2 my-3">
                    ...
                    <div class="col-md-2">
                      <p class="mb-0">
                        <?php echo html_escape($appointment->duration).' '.trans($appointment->duration_type); ?>
                      </p>
                    </div>
                  </div>
                <?php endforeach ?>
