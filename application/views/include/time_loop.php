	...
	<?php else: ?>
		...
		<div class="time_wrap" style="height: <?php if(count($times) > 20){echo "369px";}else{ echo "auto"; } ?>;">
			<?php foreach ($times as $time): ?>
				...
				<div class="time_group pt-1"> 
					<div class="btn-group w-100">
					    <label class="btn btn-light-success btn-sm time_btn shadow-none <?php echo $staff_time_slot; ?> <?php echo $break_slot; ?> <?php if($check == TRUE){echo 'disabled';} ?> <?php if($current_date == $date && $current_time > $start_time){echo 'disabled';} ?>">
