<div class="col-md-12 mb-4">
    ...
    <?php $service_status = check_coupon_status($appointment->service_id, $appointment->business_id); ?>
        ...
        <?php if(!empty($appointment->service_extra)): ?>
            <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
                ...
                <div>
                    ...
                    ?> -->
                    <p class="text-dark font-weight-bold mb-0">
                        <?php if($company->curr_locate == 0){echo get_currency_by_country($company->country)->currency_symbol;} ?> <span class="coupon_amount"><?php if($total_extra != 0){echo number_format($total_extra, $company->num_format);}else{echo number_format(0, $company->num_format);} ?></span> <?php if($company->curr_locate == 1){echo get_currency_by_country($company->country)->currency_symbol;} ?>
                    </p>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
            ...
            <div>
                <p class="text-dark font-weight-bold mb-0">
                    <?php if($company->curr_locate == 0){echo get_currency_by_country($company->country)->currency_symbol;} ?> <span class="coupon_amount"><?php if($tax_amount != 0){echo number_format($tax_amount, $company->num_format);}else{echo number_format(0, $company->num_format);} ?></span> <?php if($company->curr_locate == 1){echo get_currency_by_country($company->country)->currency_symbol;} ?>
                </p>
            </div>
        </div>
