...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        // Add webhook_url column to business
        mysqli_query($connection, "ALTER TABLE `business` ADD `webhook_url` VARCHAR(500) NULL DEFAULT NULL AFTER `wazfy_token`;");
...
<head>
    ...
    <title>Aoxio • Update Installer</title>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab_1">
                                                ...
                                                <div class="form-group">
                                                    <label>Host</label>
                                                    <input type="text" class="form-control form-input" name="db_host" placeholder="Host" value="<?php echo isset($_SESSION["db_host"]) ? $_SESSION["db_host"] : 'localhost'; ?>" required>
                                                </div>
                                                <div class="form-group">
