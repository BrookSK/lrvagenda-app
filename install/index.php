...
<head>
    ...
    <title>Aoxio &bull; Installer</title>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" readonly placeholder="Enter Purchase Code" required>xrOdP9vrbTO83XmoKTRUSQYHUHAtnrdxnrPm</textarea>
                                            </div>
